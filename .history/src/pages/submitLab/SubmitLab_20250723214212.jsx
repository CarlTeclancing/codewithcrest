  ...
  return (
    <Layout>
      ...
      <div className="submit-option">
        <button className={`button ${location.pathname === "/submitlab" ? "active" : ""}`}>Upload File</button>
        <button className={`button ${location.pathname === "/submitlab" ? "active" : ""}`}>Submit Link</button>
      </div>
    </Layout>
  )
}
