        ...
        <p>
          <div className="form-post">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{display:'flex', justifyContent:'space-around', alignItems}}>
                <span className="hashtags">#Javascript </span>
                <span className="hashtags">#HTML</span>
                <span className="hashtags">#CSS</span>
                <span className="hashtags">#Python</span>
              </div>
